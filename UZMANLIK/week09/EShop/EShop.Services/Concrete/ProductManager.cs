...
public class ProductManager : IProductService
{
    ...
    public async Task<ResponseDto<ProductDto>> AddAsync(ProductCreateDto productCreateDto)
    {
        try
        {
            ...
            {
                return ResponseDto<ProductDto>.Fail("Ürün en az bir kategoriye sahip olmalıdır.", StatusCodes.Status400BadRequest);
            }
    ...
    public async Task<ResponseDto<NoContent>> UpdateAsync(ProductUpdateDto productUpdateDto)
    {
        try
        {
            ...
            {
                return ResponseDto<NoContent>.Fail("Ürün en az bir kategoriye sahip olmalıdır.", StatusCodes.Status400BadRequest);
            }
