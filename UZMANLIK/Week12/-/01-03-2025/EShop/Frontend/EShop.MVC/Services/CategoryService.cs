...
namespace EShop.MVC.Services
{
    public class CategoryService : ICategoryService
    {
        ...
        public Task<ResponseModel<List<CategoryModel>>> GetAllDeletedAsync()
        {
            try
            {
                var response = _httpClientService.GetAsync<ResponseModel<List<CategoryModel>>>("categories/deleted");
                return response;
            }
            catch (Exception e)
            {
