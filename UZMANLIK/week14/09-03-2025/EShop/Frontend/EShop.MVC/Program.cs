...
app.Run();
//Eğer uygulama "Geliştirme (Development)" modunda değilse:
//Hata sayfası olarak /Home/Error yönlendirilmiş.
//HSTS (HTTP Strict Transport Security) etkinleştirilmiş.
// Canlı ortama uygun bir yapı kurulmuş.